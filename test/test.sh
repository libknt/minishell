...
## expand
assert 'ls | echo $PATH'
assert 'ls | echo $PATH $PATH'
assert 'ls | echo $PATH $PATH $PATH'
assert "ls | echo '\$PATH'"
assert 'ls | echo "$PATH"'
...
assert 'ls | chmod 000 perm.out\nperm.out'
assert 'ls | chmod 000 perm.out\n./perm.out'
assert 'ls | chmod 111 perm.out\nperm.out'
assert 'ls | chmod 111 perm.out\n./perm.out'
assert 'ls | chmod 222 perm.out\nperm.out'
assert 'ls | chmod 222 perm.out\n./perm.out'
assert 'ls | chmod 333 perm.out\nperm.out'
assert 'ls | chmod 333 perm.out\n./perm.out'
assert 'ls | chmod 444 perm.out\nperm.out'
assert 'ls | chmod 444 perm.out\n./perm.out'
assert 'ls | chmod 555 perm.out\nperm.out'
assert 'ls | chmod 555 perm.out\n./perm.out'
assert 'ls | chmod 666 perm.out\nperm.out'
assert 'ls | chmod 666 perm.out\n./perm.out'
assert 'ls | chmod 777 perm.out\nperm.out'
assert 'ls | chmod 777 perm.out\n./perm.out'
assert 'ls | chmod 000 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 000 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 111 perm.out\ncd ..\ntest/perm.out'
...
assert 'ls | chmod 777 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 777 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 077 perm.out\nperm.out'
assert 'ls | chmod 077 perm.out\n./perm.out'
assert 'ls | chmod 077 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 077 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 177 perm.out\nperm.out'
assert 'ls | chmod 177 perm.out\n./perm.out'
assert 'ls | chmod 177 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 177 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 277 perm.out\nperm.out'
assert 'ls | chmod 277 perm.out\n./perm.out'
assert 'ls | chmod 277 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 277 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 377 perm.out\nperm.out'
assert 'ls | chmod 377 perm.out\n./perm.out'
assert 'ls | chmod 377 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 377 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 477 perm.out\nperm.out'
assert 'ls | chmod 477 perm.out\n./perm.out'
assert 'ls | chmod 477 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 477 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 577 perm.out\nperm.out'
assert 'ls | chmod 577 perm.out\n./perm.out'
assert 'ls | chmod 577 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 577 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 677 perm.out\nperm.out'
assert 'ls | chmod 677 perm.out\n./perm.out'
assert 'ls | chmod 677 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 677 perm.out\ncd ..\n./test/perm.out'

assert 'ls | chmod 707 perm.out\nperm.out'
assert 'ls | chmod 707 perm.out\n./perm.out'
assert 'ls | chmod 707 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 707 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 717 perm.out\nperm.out'
assert 'ls | chmod 717 perm.out\n./perm.out'
assert 'ls | chmod 717 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 717 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 727 perm.out\nperm.out'
assert 'ls | chmod 727 perm.out\n./perm.out'
assert 'ls | chmod 727 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 727 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 737 perm.out\nperm.out'
assert 'ls | chmod 737 perm.out\n./perm.out'
assert 'ls | chmod 737 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 737 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 747 perm.out\nperm.out'
assert 'ls | chmod 747 perm.out\n./perm.out'
assert 'ls | chmod 747 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 747 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 757 perm.out\nperm.out'
assert 'ls | chmod 757 perm.out\n./perm.out'
assert 'ls | chmod 757 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 757 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 767 perm.out\nperm.out'
assert 'ls | chmod 767 perm.out\n./perm.out'
assert 'ls | chmod 767 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 767 perm.out\ncd ..\n./test/perm.out'

assert 'ls | chmod 770 perm.out\nperm.out'
assert 'ls | chmod 770 perm.out\n./perm.out'
assert 'ls | chmod 770 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 770 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 771 perm.out\nperm.out'
assert 'ls | chmod 771 perm.out\n./perm.out'
assert 'ls | chmod 771 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 771 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 772 perm.out\nperm.out'
assert 'ls | chmod 772 perm.out\n./perm.out'
assert 'ls | chmod 772 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 772 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 773 perm.out\nperm.out'
assert 'ls | chmod 773 perm.out\n./perm.out'
assert 'ls | chmod 773 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 773 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 774 perm.out\nperm.out'
assert 'ls | chmod 774 perm.out\n./perm.out'
assert 'ls | chmod 774 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 774 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 775 perm.out\nperm.out'
assert 'ls | chmod 775 perm.out\n./perm.out'
assert 'ls | chmod 775 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 775 perm.out\ncd ..\n./test/perm.out'
assert 'ls | chmod 776 perm.out\nperm.out'
assert 'ls | chmod 776 perm.out\n./perm.out'
assert 'ls | chmod 776 perm.out\ncd ..\ntest/perm.out'
assert 'ls | chmod 776 perm.out\ncd ..\n./test/perm.out'
